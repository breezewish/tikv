...
const DEFAULT_GRPCWORKER_READ_CRITICAL_CONCURRENCY: usize = 1;
const DEFAULT_GRPCWORKER_READ_HIGH_CONCURRENCY: usize = 1;
const DEFAULT_GRPCWORKER_READ_NORMAL_CONCURRENCY: usize = 1;
const DEFAULT_GRPCWORKER_READ_LOW_CONCURRENCY: usize = 1;
const DEFAULT_GRPCWORKER_MAX_READ_TASKS: usize = 20480;
const DEFAULT_GRPCWORKER_STACK_SIZE_MB: u64 = 10;
...
pub struct Config {
    ...
    pub grpc_worker_read_critical_concurrency: usize,
    pub grpc_worker_read_high_concurrency: usize,
    pub grpc_worker_read_normal_concurrency: usize,
    pub grpc_worker_read_low_concurrency: usize,
    pub grpc_worker_max_read_tasks: usize,
    pub grpc_worker_stack_size: ReadableSize,
...
impl Default for Config {
    fn default() -> Config {
        ...
        Config {
            ...
            grpc_worker_read_critical_concurrency: DEFAULT_GRPCWORKER_READ_CRITICAL_CONCURRENCY,
            grpc_worker_read_high_concurrency: DEFAULT_GRPCWORKER_READ_HIGH_CONCURRENCY,
            grpc_worker_read_normal_concurrency: DEFAULT_GRPCWORKER_READ_NORMAL_CONCURRENCY,
            grpc_worker_read_low_concurrency: DEFAULT_GRPCWORKER_READ_LOW_CONCURRENCY,
            grpc_worker_max_read_tasks: DEFAULT_GRPCWORKER_MAX_READ_TASKS,
            grpc_worker_stack_size: ReadableSize::mb(DEFAULT_GRPCWORKER_STACK_SIZE_MB),
        }
    }
}
